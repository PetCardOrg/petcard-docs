...
- **`architecture/adr/`** — ADRs numerados (`001-multirepo-strategy`, `002-m4-integracoes-externas`, `003-m5-interface-veterinario`, `004-modo-offline-rf15`, `005-verificacao-crmv-e-acesso-clinico`, `006-cobertura-de-confianca`, `007-remocao-role-vestigial-em-tutor`, `008-fluxo-cadastro-e-login`, `009-autoria-da-nota-clinica-e-exclusao-do-veterinario`). Próximo número = 010+.
