...
- **`architecture/adr/`** — ADRs numerados (`001-multirepo-strategy`, `002-m4-integracoes-externas`, `003-m5-interface-veterinario`, `004-modo-offline-rf15`, `005-verificacao-crmv-e-acesso-clinico`, `006-cobertura-de-confianca`, `007-remocao-role-vestigial-em-tutor`). Próximo número = 008+.
